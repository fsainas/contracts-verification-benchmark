...
contract Escrow {
    ...
    uint last_choose_block;
    uint last_arbitrate_block;
    ...
    function choose(address _choice) public beforeEndChoice {
        ...
        last_choose_block = block.number;
    ...
    function arbitrate(address _eChoice) public afterEndReedem {
        ...
        last_arbitrate_block = block.number;
        require(last_arbitrate_block > last_choose_block);
    ...
    function invariant() public view {
        //assert(block.number < end_choice || block.number > end_redeem);
        assert(end_choice < end_redeem);    // Proved
